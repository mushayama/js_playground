...
This is a tic-tac-toe game created within the following constraints:

I found the statement [here](https://workat.tech/machine-coding/practice/design-tic-tac-toe-smyfi9x064ry)
...
run the dev or test scripts as mentioned in package.json as required
